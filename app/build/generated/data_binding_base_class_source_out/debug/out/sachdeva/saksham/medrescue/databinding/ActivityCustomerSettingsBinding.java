...
public final class ActivityCustomerSettingsBinding implements ViewBinding {
  ...
  private ActivityCustomerSettingsBinding(@NonNull LinearLayout rootView, @NonNull Button back,
      @NonNull Button confirm, @NonNull EditText name, @NonNull EditText phone,
  ...
  public static ActivityCustomerSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomerSettingsBinding((LinearLayout) rootView, back, confirm, name,
          phone, textView2);
    }
