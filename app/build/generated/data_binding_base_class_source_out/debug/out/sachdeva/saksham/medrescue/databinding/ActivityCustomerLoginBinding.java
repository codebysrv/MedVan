...
public final class ActivityCustomerLoginBinding implements ViewBinding {
  ...
  private ActivityCustomerLoginBinding(@NonNull RelativeLayout rootView, @NonNull EditText email,
      @NonNull Button forgetPassword, @NonNull ImageView imageView, @NonNull Button login,
      @NonNull EditText password, @NonNull Button registration, @NonNull TextView textView,
  ...
  public static ActivityCustomerLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomerLoginBinding((RelativeLayout) rootView, email, forgetPassword,
          imageView, login, password, registration, textView, textView3);
    }
